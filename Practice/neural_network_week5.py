...
x5 = 0,0,0,0,1
x6 = 0,0,0,0,0
x_or_1 = np.array([x0,x1,x2,x3,x4,x5,x6])
theta = -10,20,20,20,20,20,20
theta2 = 10,-20,-20,-20,20,20,20
...
print(x_or_1.shape)
print(y.shape)
range_array = np.arange(0,7,1)
theta = np.array(range_array)
print(theta)
J,grad,h_x = cost_function(theta,x_or_1,y,lambda_)
print(J,grad,h_x)
